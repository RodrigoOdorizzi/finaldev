            ...
            <div class="container">
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <p class="px-5 pb-3 lead blue-grey-text">
                        Você está em: <a href="index.php">Index </a> -> <a href="Cadastros.php"> Cadastros </a> -> <a href="index_fabricante.php"> Fabricantes </a>
                    </p>
                    ...
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <form method="post">
                            <div class="form-group col-lg-12">
                                <input type="text" class="form-control" name="consulta" id="consulta" placeholder="Ex: Pfizer">
                             ...
                             LIKE '$consulta%'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href='show_fabricante.php?id=<?php echo $fabricante->getCodigo(); ?>'> <i class="fa fa-search fa-2x black-text" style="text-align: center;"></i> </a></td>
                                        <td><a href='cad_fabricante.php?acao=editar&codigo=<?php echo $fabricante->getCodigo(); ?>'><i class="fa fa-pencil-square-o fa-2x black-text""></i></a></td>
                                        <td><a href=" javascript:excluirRegistro('acao_fabricante.php?acao=excluir&codigo=<?php echo $fabricante->getCodigo(); ?>')"><i class="fa fa-trash-o fa-2x black-text""></a></td>
                                    </tr>                                                                                                  
                                <?php } ?>

        ...
        <section class="text-center py-5 grey lighten-4" id="about">
            <div class="container">
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <h2 class="h1 pt-5 pb-3">Lista de usuarios</h2>
                </div>
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <p class="px-5 pb-3 lead blue-grey-text">
                        Você está em: <a href="index.php">Index </a> -> <a href="Pessoas.php"> Pessoas </a> -> <a href="index_2.php">Usuarios </a>
                    </p>
                    ...
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <form method="post">
                            <div class="form-group col-lg-12">
                                <input type="text" class="form-control" name="consulta" id="consulta" placeholder="Ex: id usuario">
                        ...
                        <a href="cad_2.php">
                            <button class="btn btn-sm btn-secondary" style="float: right; ">Cadastrar usuario</button>
                        </a>
                        <br>
                             ...
                             LIKE '$consulta%'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href='show.php?id=<?php echo $vacina->getCodigo(); ?>'> <i class="fa fa-search fa-2x black-text" style="text-align: center;"></i> </a></td>
                                        <td><a href='cad_2.php?acao=editar&codigo=<?php echo $vacina->getCodigo(); ?>'><i class="fa fa-pencil-square-o fa-2x black-text""></i></a></td>
                                        <td><a href=" javascript:excluirRegistro('acao_2.php?acao=excluir&codigo=<?php echo $vacina->getCodigo(); ?>')"><i class="fa fa-trash-o fa-2x black-text""></a></td>
                                    </tr>
                                <?php } ?>

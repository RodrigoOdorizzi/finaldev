            ...
            <div class="container">
                ...
                <section class="row no-gutters" id="features">
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <br>
                        <a href="index_doenca.php"><button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button></a>
                        ...
                        <form action="acao_doenca.php" method="post">
                            ...
                            <input required=true type="text" class="form-control" placeholder="Nome da Doenca" name="nome" id="nome" value="<?php if ($acao == "editar") echo $obj->getNome(); ?>"><br>

        ...
        <section class="text-center py-5 grey lighten-4" id="about">
            <div class="container">
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <h2 class="h1 pt-5 pb-3">Lista de Vacinas</h2>
                </div>
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <p class="px-5 pb-3 lead blue-grey-text">
                        Você está em: <a href="index.php">Index </a> -> <a href="Cadastros.php"> Cadastros </a> -> <a href="index_vacina.php">Vacinas </a>
                    </p>
                    ...
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $consulta = $pdo->query("SELECT * FROM vacina
                             WHERE nome
                             LIKE '$consulta%'");
                                while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                                    $vacina = new Vacina;
                                    $vacina->buildFromArray($linha);
                                ?>
                                    <tr>

                                        <td><?php echo $vacina->getNome(); ?></td>

                                        <td><a href='show_vacina.php?id=<?php echo $vacina->getCodigo(); ?>'> <i class="fa fa-search fa-2x black-text" style="text-align: center;"></i> </a></td>
                                        <td><a href='cad_vacina.php?acao=editar&codigo=<?php echo $vacina->getCodigo(); ?>'><i class="fa fa-pencil-square-o fa-2x black-text""></i></a></td>
                                        <td><a href=" javascript:excluirRegistro('acao_vacina.php?acao=excluir&codigo=<?php echo $vacina->getCodigo(); ?>')"><i class="fa fa-trash-o fa-2x black-text""></a></td>
                                    </tr>                                                                                                  
                                <?php } ?>

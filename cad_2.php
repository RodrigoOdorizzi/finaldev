             ...
             <div class="container">
                 ...
                 <section class="row no-gutters" id="features">
                     <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                         ...
                         <br>
                         <a href="index_2.php"><button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button></a>
                         ...
                         <form action="acao_2.php" method="post">
                             ...
                             <input required=true type="text" class="form-control" placeholder="senha" name="senha" id="senha" value="<?php if ($acao == "editar") echo $obj->getSenha(); ?>"><br>
                             <input required=true type="text" class="form-control" placeholder="user" name="user" id="user" value="<?php if ($acao == "editar") echo $obj->getUser(); ?>"><br>
                             <input required=true type="text" class="form-control" placeholder="id" name="id_permissao" id="id_permissao" value="<?php if ($acao == "editar") echo $obj->getId_permissao(); ?>"><br>

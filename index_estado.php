        ...
        <section class="text-center py-5 grey lighten-4" id="about">
            <div class="container">
                ...
                <div class="wow fadeIn mt-5">
                    ...
                    <h2 class="h1 pt-5 pb-3">Lista de Estados</h2>
                </div>
                    ...
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <form method="post">
                            <div class="form-group col-lg-12">
                                <input type="text" class="form-control" name="consulta" id="consulta" placeholder="Ex: ac">
                                <input type="submit" class="btn btn-secondary btn-sm" value="Pesquisar">


                            </div>
                        </form>
                        <a href="cad_estado.php">
                            <button class="btn btn-sm btn-secondary" style="float: right; ">Cadastrar estado</button>
                        </a>
                        <br>
                            ...
                            <tbody>
                             ...
                             LIKE '$consulta%'");
                                while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                                    $estadoe = new Estado;
                                    $estadoe->buildFromArray($linha);
                                ?>
                                    <tr>

                                        <td><?php echo $estadoe->getNome(); ?></td>

                                        <td><a href='show_estadoe.php?id=<?php echo $estadoe->getCodigo(); ?>'> <i class="fa fa-search fa-2x black-text" style="text-align: center;"></i> </a></td>
                                        <td><a href='cad_estadoe.php?acao=editar&codigo=<?php echo $estadoe->getCodigo(); ?>'><i class="fa fa-pencil-square-o fa-2x black-text""></i></a></td>
                                        <td><a href=" javascript:excluirRegistro('acao_estadoe.php?acao=excluir&codigo=<?php echo $estadoe->getCodigo(); ?>')"><i class="fa fa-trash-o fa-2x black-text""></a></td>
                                    </tr>                                                                                                  
                                <?php } ?>

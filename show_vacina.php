             ...
             <div class="container">
                 ...
                 <section class="row no-gutters" id="features">
                     <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                         ...
                         <a href="index_vacina.php"> <button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button>
                         </a>



                         <a href="cad_vacina.php?acao=editar&codigo=<?php echo $id; ?>"> <button class="btn btn-sm btn-secondary" style="float: right; ">Alterar</button></a>
                         </br></br>

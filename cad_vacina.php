             ...
             <div class="container">
                 ...
                 <section class="row no-gutters" id="features">
                     <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                         ...
                         <br>
                         <a href="index_vacina.php"><button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button></a>



                         <form action="acao_vacina.php" method="post">
                             ...
                             <input required=true type="text" class="form-control" placeholder="id_doenca" name="id_doenca" id="id_doenca" value="<?php if ($acao == "editar") echo $obj->getId_doenca(); ?>"><br>
                             <input required=true type="text" class="form-control" placeholder="id_fabricante" name="id_fabricante" id="id_fabricante" value="<?php if ($acao == "editar") echo $obj->getId_fabricante(); ?>"><br>
                             <input required=true type="text" class="form-control" placeholder="lote" name="lote" id="lote" value="<?php if ($acao == "editar") echo $obj->getLote(); ?>"><br>

             ...
             <div class="container">
                 ...
                 <section class="row no-gutters" id="features">
                     <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                         ...
                         <a href="cad_2.php">
                             <button class="btn btn-sm btn-secondary" style="float: right; ">Cadastrar user</button>
                         </a>




                         <a href="index_2.php"> <button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button>
                         </a>



                         <a href="cad_2.php?acao=editar&codigo=<?php echo $id; ?>"> <button class="btn btn-sm btn-secondary" style="float: right; ">Alterar</button></a>
                         </br></br>

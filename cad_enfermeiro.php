...
require_once "acao_enfermeiro.php";
        ...
        <section class="text-center py-5 grey lighten-4" id="about">
            <div class="container">
                <div class="wow fadeIn">
                    <h2 class="h1 pt-5 pb-3">Cadastro de enfermeiros</h2>
            ...
            <div class="container">
                ...
                <section class="row no-gutters" id="features">
                    <div class="col-lg-12 lighten-1 text-white" style="background-color: #f8fecd;">
                        ...
                        <br>
                        <a href="index_enfermeiro.php"><button class="btn btn-sm btn-secondary" style="float: right; ">Listar</button></a>
                        ...
                        <form action="acao_enfermeiro.php" method="post">
                            ...
                            <input required=true type="text" class="form-control" placeholder="id_user" name="id_pessoa" id="id_pessoa" value="<?php if ($acao == "editar") echo $obj->getId_user(); ?>"><br>
